...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='table',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_auth.table'),
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
        ...
        migrations.AddField(
            model_name='groupstudent',
            name='teacher',
            field=models.ManyToManyField(related_name='get_teacher', to='user_auth.teacher'),
        ),
    ]
